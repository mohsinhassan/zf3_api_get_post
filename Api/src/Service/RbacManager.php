...
class RbacManager 
{
     ...
     */
    public function __construct($entityManager, $assertionManagers ,$cache)  //
    {
    ...
    public function init($forceCreate = false)
    {
        ...
        // If Api wants us to reinit RBAC container, clear cache now.
        if ($forceCreate) {
     ...
     */
    public function isGranted($identity, $permission, $params = null)
    {
        if ($this->rbac==null) {
            $this->init();
        }
