...
class SsoController extends ApiController
{
    ...
    public function __construct($entityManager, $ssoManager, $authService, $ssoMetaManager, $apiValidateTokenManager)
    {
    ...
    public function getuserIdNameAction()
    {
        ...
        $user = $this->entityManager->getRepository(Usersso::class)->getUserIdName($data['username']);
